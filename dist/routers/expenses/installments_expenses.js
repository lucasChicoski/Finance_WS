...
var installments_expenses_exports = {};
__export(installments_expenses_exports, {
  installmentsExpensesRouters: () => routers
});
module.exports = __toCommonJS(installments_expenses_exports);
...
// src/routers/expenses/installments_expenses.ts
var ct = new ExpenseInstallmentsController(new ExpensesInstallmentsService());
function routers(app) {
  app.post("/register-installments-expense", (req, res) => ct.createInstallmentsExpense(req, res));
  app.post("/get-installments-expense", (req, res) => ct.getInstallmentsExpense(req, res));
}
// Annotate the CommonJS export names for ESM import in node:
0 && (module.exports = {
  installmentsExpensesRouters
});
