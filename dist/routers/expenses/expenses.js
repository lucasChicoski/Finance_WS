...
// src/routers/expenses/expenses.ts
var srv = new ExpenseService();
var ct = new ExpenseController(srv);
function routers(app) {
  app.post("/register-expense", (req, res) => ct.createExpnese(req, res));
  app.post("/get-expense", (req, res) => ct.getExpense(req, res));
  app.post("/delete-expense", (req, res) => ct.deleteExpense(req, res));
  app.post("/update-expense", (req, res) => ct.updateExpnese(req, res));
}
