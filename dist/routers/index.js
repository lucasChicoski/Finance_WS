...
function routers2(app) {
  app.post("/get-user", (req, res) => ct2.getUser(req, res));
  app.post("/create-user", (req, res) => ct2.createUser(req, res));
}
...
function routers3(app) {
  app.post("/register-expense", (req, res) => ct3.createExpnese(req, res));
  app.post("/get-expense", (req, res) => ct3.getExpense(req, res));
  app.post("/delete-expense", (req, res) => ct3.deleteExpense(req, res));
  app.post("/update-expense", (req, res) => ct3.updateExpnese(req, res));
}

// src/routers/status/status_router.ts
function routers4(app) {
  app.get("/status", (req, res) => res.render("api-status"));
}
...
function routers5(app) {
  app.post("/register-installments-expense", (req, res) => ct4.createInstallmentsExpense(req, res));
  app.post("/get-installments-expense", (req, res) => ct4.getInstallmentsExpense(req, res));
}
...
function routers6(app) {
  app.post("/get-categories", (req, res) => ctl.getCategories(req, res));
}
...
function routers7(app) {
  app.post("/group-by-category-expense", (req, res) => ctl2.getExpenseGroupByCategoryExpense(req, res));
}
...
function routers8(app) {
  app.post("/auth", (req, res) => ct5.handleLogin(req, res));
}

// src/routers/index.ts
function indexRouters(app) {
  routers(app);
  routers2(app);
  routers3(app);
  routers4(app);
