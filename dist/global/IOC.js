...
__export(IOC_exports, {
  ...
  RepositoryTtype: () => RepositoryTtype
});
...
// src/global/IOC.ts
var RepositoryTtype = /* @__PURE__ */ ((RepositoryTtype2) => {
  RepositoryTtype2[RepositoryTtype2["FinanceConfig"] = 0] = "FinanceConfig";
  RepositoryTtype2[RepositoryTtype2["UserConfig"] = 1] = "UserConfig";
  RepositoryTtype2[RepositoryTtype2["Expense"] = 2] = "Expense";
  RepositoryTtype2[RepositoryTtype2["ExpenseInstallments"] = 3] = "ExpenseInstallments";
  RepositoryTtype2[RepositoryTtype2["Category"] = 4] = "Category";
  RepositoryTtype2[RepositoryTtype2["QueryExpense"] = 5] = "QueryExpense";
  RepositoryTtype2[RepositoryTtype2["Auth"] = 6] = "Auth";
  return RepositoryTtype2;
})(RepositoryTtype || {});
