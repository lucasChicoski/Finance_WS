...
CREATE TABLE "Despesas" (
    ...
    "id_despesas_parceladas" INTEGER,
...
-- AddForeignKey
ALTER TABLE "Despesas" ADD CONSTRAINT "Despesas_id_category_fkey" FOREIGN KEY ("id_category") REFERENCES "CategoryExpenses"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
